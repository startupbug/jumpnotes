...
Route::get('tutor/set-schedule', 'TutorController@tutorSetSchedule')->name('setSchedule');
Route::post('tutor/set-schedule/ajax', 'TutorController@tutorSetScheduleAjax')->name('submitSheduleAjax');
