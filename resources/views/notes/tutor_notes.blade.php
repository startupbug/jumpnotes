    ...
    <div class="meet-with">
        <div class="container-fluid">
            ...
            <div class="first-row" id="searchList">
              @if($notes->isEmpty())
              <p style="color:#FF3700">No notes available of this tutor</p>
              @endif
                                ...
                                <div class="pos-left details detail-home">
                                    ...
                                    <a href="{{route('single_note',['id' => $note->notes_id])}}" class="pull-left col-md-12 file-ico">
                                        ...
                                        @else
                                            ...
                                            @else
                                               <div class="overlay-viewnotes"></div> <iframe src="http://docs.google.com/gview?url={{asset('/public/notes/')}}/{{$note->note_file}}&embedded=true" width="100%" height="600px"></iframe>
                                            @endif
